...
describe("<Question />", () => {
  it("Question shows post status", () => {
    ...
    cy.getDateCyTest("post-stats").should("contains.text", "answer");
    cy.getDateCyTest("post-stats").should("contains.text", "view");
  });
  ...
  it("Post status show answer & view as singular when there is 0 answer and 0 view", () => {
    ...
    const handleAnswerSpy = cy.spy().as("handleAnswerSpy");
    cy.mount(<Question q={q} clickTag={clickTagSpy} handleAnswer={handleAnswerSpy} />);
    cy.getDateCyTest("post-stats").should("have.text", "0 answer0 view");
  });
  ...
  it("Post status show answer & view as singular when there is 1 answer and 1 view", () => {
    ...
    const handleAnswerSpy = cy.spy().as("handleAnswerSpy");
    cy.mount(<Question q={q} clickTag={clickTagSpy} handleAnswer={handleAnswerSpy} />);
    cy.getDateCyTest("post-stats").should("have.text", "1 answer1 view");
  });
  ...
  it("Post status show answer as plural when there is more than 1 answer", () => {
    ...
    const handleAnswerSpy = cy.spy().as("handleAnswerSpy");
    cy.mount(<Question q={q} clickTag={clickTagSpy} handleAnswer={handleAnswerSpy} />);
    cy.getDateCyTest("post-stats").should("have.text", "2 answers2 views");
  });
  ...
  it("Question shows title", () => {
    ...
    const handleAnswerSpy = cy.spy().as("handleAnswerSpy");
    cy.mount(<Question q={q} clickTag={clickTagSpy} handleAnswer={handleAnswerSpy} />);
    cy.getDateCyTest("post-title").should("contains.text", "Test Question");
  });
  ...
  it("Question shows tags", () => {
    ...
    const handleAnswerSpy = cy.spy().as("handleAnswerSpy");
    cy.mount(<Question q={q} clickTag={clickTagSpy} handleAnswer={handleAnswerSpy} />);
    cy.getDateCyTest("question-tags").should("contains.text", "tag1");
    cy.getDateCyTest("question-tags").should("contains.text", "tag2");
  });
  ...
  it("Question shows author", () => {
    ...
    const handleAnswerSpy = cy.spy().as("handleAnswerSpy");
    cy.mount(<Question q={q} clickTag={clickTagSpy} handleAnswer={handleAnswerSpy} />);
    cy.getDateCyTest("last-activity").should("contains.text", "Test User");
  });
  ...
  it("Question shows asked date time", () => {
    ...
    const handleAnswerSpy = cy.spy().as("handleAnswerSpy");
    cy.mount(<Question q={q} clickTag={clickTagSpy} handleAnswer={handleAnswerSpy} />);
    cy.getDateCyTest("last-activity").should("contains.text", "asked Jan 01 at 01:01:01");
  });
